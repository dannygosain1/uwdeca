...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=74c34ff097e9be7d5878)
 * Config saved to config.json and https://gist.github.com/74c34ff097e9be7d5878
 */
 ...
 * Version: 0.10.0 - 2014-02-08
 * License: MIT
 */
angular.module("ui.bootstrap", ["ui.bootstrap.tpls", "ui.bootstrap.transition","ui.bootstrap.progressbar","ui.bootstrap.tabs"]);
angular.module("ui.bootstrap.tpls", ["template/progressbar/bar.html","template/progressbar/progress.html","template/progressbar/progressbar.html","template/tabs/tab.html","template/tabs/tabset.html"]);
    ...
    compile: function(elm, attrs, transclude) {
      return function postLink(scope, elm, attrs, tabsetCtrl) {
        ...
        if (attrs.active) {
          ...
          scope.$watch(getActive, function updateActive(value, oldVal) {
...
angular.module('uwdeca').controller('calendarController', ['$scope', function($scope){
	$scope.gcalLink = 'https://www.google.com/calendar/feeds/uwdeca.com_lmus1sc1t5lr4ic1p76srvsnb8%40group.calendar.google.com/private-a6a00128d4baeec4abff0d97b9f16538/basic';
}]);
...
angular.module('uwdeca').controller('executivesController', ['$scope', function ($scope){
	...
	$scope.execs = array_utils.partition([
		...
		{
			name: 'alexandra sharr',
			bio: '',
			level: 'junior executive'
		},
		{
			name: 'sahaana ruthirakanthan',
			bio: '',
			level: 'junior executive'
		},
		{
...
angular.module('uwdeca').controller('mainController', ['$scope', '$location', function($scope, $location){
    ...
    $scope.facebookPicsLink = 'https://www.facebook.com/UWDECA/photos_stream';
...
angular.module('uwdeca').directive('calendar', [function(){
	...
	return {
		...
		link: function($scope, $elem, attrs, controller) {
			$elem.fullCalendar({
        googleCalendarApiKey: 'AIzaSyAs33ZnufqmrCiKVhKVIPWFEnlnKOS25n8',
				events: {
          googleCalendarId: 'uwdeca.com_lmus1sc1t5lr4ic1p76srvsnb8@group.calendar.google.com'
        }
			});
		}
	};
...
},{"../../lib/js/utilities/array":2,"underscore":3}],2:[function(require,module,exports){
var exports = {};
